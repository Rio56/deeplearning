...
def bootStrapping_allneg_continue_val(trainfile=None,valfile=None,
  ...
  val_physicalX,val_physicalY = convertRawToXY(val_all.as_matrix(),codingMode=6)
  ...
  for I in range(nb_epoch1):
    ...
    for t in range(nclass):
        ...
        train_physicalX,train_physicalY = convertRawToXY(train_all.as_matrix(),codingMode=6)
        if t==0: 
            ...
            models=MultiCNN(train_physicalX,train_physicalY,val_physicalX,val_physicalY,nb_epoch=nb_epoch2,earlystop=earlystop,transferlayer=transferlayer,weights=inputweights,forkinas=forkinas,compiletimes=t)
            ...
            models=MultiCNN(train_physicalX,train_physicalY,val_physicalX,val_physicalY,nb_epoch=nb_epoch2,earlystop=earlystop,transferlayer=transferlayer,weights=inputweights,forkinas=forkinas,compiletimes=t,compilemodels=models)
            #models=MultiCNN(trainX1,trainY1,train_physicalX,train_physicalY,valX1,valY1,val_physicalX,val_physicalY,nb_epoch=nb_epoch2,earlystop=earlystop,transferlayer=transferlayer,weights=inputweights,forkinas=forkinas,compiletimes=t,compilemodels=models)
