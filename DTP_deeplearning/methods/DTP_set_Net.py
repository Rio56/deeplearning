...
def zyh_CNN(trainX, trainY, valX=None, valY=None, compiletimes=0, forkinas=False, transferlayer=1, compilemodels=None,
            earlystop=None, nb_epoch=1000, batch_size=7024, fildername=None):
    """
    :argument
    :return:
    """
...
def zyh_CNN_one_hot_flying(trainX, trainY, valX=None, valY=None, compiletimes=0, forkinas=False, transferlayer=1, compilemodels=None,
            earlystop=None, nb_epoch=1000, batch_size=7024, fildername=None):
    """
    :argument
    :return:
