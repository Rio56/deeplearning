...
class GetSample():
    ...
    def main(self,winn= 0,random_nag = False,rate = 1.0):
        ...
        train_label,train_feature = self.get_label_fealist(labelIDslist,lablenum,pssm,topo,onehot,aaindex,win = winn)       
        #test_label,test_feature = self.get_label_fealist(test_labelID,lablenum,pssm,topo,onehot,psipred,aaindex,win = winn,array=True)
    ...
    def getlabels(self):
        sPickle = open('/home/luchang/TMP/DATA/4Type/label_Org.pic','rb')
    ...
    #def getfixed_set(self):
        
        #l = open('/home/BiodataTest/BetaTM/featureandlabel/fixedfeature3330.pickle','rb')
        #train_fea = pickle.load(l)
        
        #f = open('/home/BiodataTest/BetaTM/featureandlabel/fixedlabel3330.pickle','rb')
    ...
    def getlabelIDsList(self):
        sPickle = open('/home/luchang/TMP/DATA/4Type/ID_Org.pic','rb')
        print('organics')
    ...
    def split_test_train(self,labelIDslist):
        labelIDs = []
        for eitem in labelIDslist:
            labelIDs.append(eitem)
        test_labelID = labelIDs[0:6]
        train_labelID = labelIDs[6:]
